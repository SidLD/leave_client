...
import { createLeaveRecord, getUserLeave, updateLeaveRecord } from "@/lib/api"
...
export default function LeaveApplicationForm() {
  ...
  const { data: leaveData , isLoading: leaveLoading} = useQuery<LeaveFormType | null>({
            ...
            <div className="form-body">
                ...
                <div className="mt-4 border-black border-y-[1px] grid-2 py-3">
                    ...
                    <div className="signature-block">
                        <div className="pt-2 pb-2 mb-0 underline-field">
                        <p className="w-full pb-2 text-center uppercase signature-name">{`${leaveData?.user?.lastName} ${leaveData?.user?.firstName}`}</p>
                        </div>
